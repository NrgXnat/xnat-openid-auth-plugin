...
public class OpenIdConnectFilterTest {
    ...
    public OpenIdConnectFilterTest() throws IOException {
        ...
        ((MockHttpServletRequest) mockRequest).setParameter("providerId", "sbs");
    ...
    public void attemptAuthentication() throws Exception {
        ...
        request.getSession().setAttribute("providerId", "sbs");

        when(this.userManagementService.getUser("sbs_1234567890")).thenThrow(UserNotFoundException.class);
